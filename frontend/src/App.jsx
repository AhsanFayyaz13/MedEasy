  ...
  return (
    <BrowserRouter>
      ...
      <div className="app-wrapper">
          ...
          <ErrorBoundary>
            <Routes>
              ...
              <Route path="/cart" element={
                <ProtectedRoute roles={['patient']}><Cart /></ProtectedRoute>
              } />
              <Route path="/checkout" element={
                <ProtectedRoute roles={['patient']}><Checkout /></ProtectedRoute>
              } />
              <Route path="/orders" element={
                <ProtectedRoute roles={['patient']}><OrderTracking /></ProtectedRoute>
              } />
        ...
        {/* Login Required Modal - inside BrowserRouter */}
        <LoginRequiredModal show={showLoginModal} onHide={closeLoginModal} />
      </div>
    </BrowserRouter>
  );
}
